            ...
            <div className="bg-white p-4 dark:bg-gray-950">
                <div className="flex items-start justify-between">
                    <div className="flex-1">
                        <p className="text-sm text-gray-500 dark:text-gray-400">{especie} {raza && `• ${raza}`}</p>
                        <h3 className="text-lg font-semibold">{name}</h3>
                        <p className="text-sm text-gray-600 dark:text-gray-300">{edad} {edad === 1 ? 'año' : 'años'}</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 line-clamp-2">{descripcion}</p>
                        <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">Por: {shelter}</p>
                    </div>
