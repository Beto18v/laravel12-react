            ...
            <div className="container relative mx-auto px-4">
                ...
                <div className="mb-16 text-center">
                    ...
                    <p className="mx-auto max-w-3xl text-xl text-gray-600 dark:text-gray-300">
                        Cada una de estas mascotas tiene una historia única y está esperando conocer a su familia perfecta. 
                        <span className="font-semibold text-green-600 dark:text-green-400"> ¿Serás tú?</span>
                    </p>
                </div>
                ...
                <div className="text-center">
                    <div className="inline-flex flex-col items-center rounded-3xl bg-gradient-to-r from-green-500 to-blue-500 p-8 text-white shadow-2xl transition-all hover:scale-105 dark:from-green-600 dark:to-blue-600">
                        ...
                        <a
                            href="/mascotas"
                            className="inline-flex items-center rounded-full bg-white px-8 py-3 font-semibold text-green-600 transition-all hover:bg-gray-100 hover:scale-105"
                        >
