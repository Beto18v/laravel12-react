...
export default function CategoryCard({ emoji, title, count, link }: CategoryCardProps) {
    ...
    return (
        ...
        >
            ...
            {/* Elemento decorativo */}
            <div className={`absolute -top-4 -right-4 h-24 w-24 rounded-full bg-gradient-to-br ${gradientClass} opacity-20 transition-all group-hover:scale-110`}></div>
            
            {/* Contenido */}
            <div className="relative z-10">
                {/* Icono principal */}
                <div className={`mb-6 inline-flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br ${gradientClass} shadow-lg transition-transform group-hover:scale-110`}>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className={`flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r ${gradientClass} transition-transform group-hover:translate-x-1`}>
